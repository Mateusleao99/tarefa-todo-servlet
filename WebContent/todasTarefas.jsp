            ...
            <div class="row">
                <div class="col-md-3 menu">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item active"><a href="todasTarefas.jsp">Todas tarefas</a></li>
                    </ul>
                </div>
                                ...
                                <ul class="list-group">
	                                <c:forEach items="${tarefa}" var="tarefa">						  
					    				<li class="list-group-item ">
					    					<div class="row">
					    						<div class="col-6">${tarefa.nomeTarefa} </div>
					    						<div class="col-3 posicaoBtn">
					    							<div>
					    								<a href="/tarefaToDo/removerTarefa?id=${tarefa.id}"><img src="img/remover.png"></a>
					    							</div>
					    							<div>
					    								<a href="/tarefaToDo/mostrarTarefas?id=${tarefa.id}"><img src="img/editar.png"></a>
					    							</div>													
					    						</div>
					    					</div>
					    				</li>
