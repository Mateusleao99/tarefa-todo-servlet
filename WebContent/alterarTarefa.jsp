...
<%--AQUI ESTAMOS ABRINDO UMA VARIAVEL COM O VALOR DO CAMINHO NOVA TAREFA --%>
 <c:url value="/alterarTarefa" var="linkServeletAlterarTarefa"/>
                    ...
                    <div class="container pagina">
                        <div class="row">
                            <div class="col">
                                ...
                                <hr/>
                                <form method="post" action="${linkServeletAlterarTarefa}">
                                    <div class="form-group">
                                        <label>Tarefa para ser alterada</label>
                                        <input class="form-control" type="text" name="tarefa" value="${tarefa.nomeTarefa}">
                                    </div>
                                    	<input type="hidden" name="id" value="${tarefa.id}">
										<button type="submit" class="btn btn-block btnCadastrar">Alterar</button>
                                </form>
                            </div>
                        </div>
                    </div>
